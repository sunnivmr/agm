...
function createStarBackground(radius, segments) {
    ...
    var texture = new THREE.TextureLoader().load('../webgl/img/stars.jpg');
...
function createRings(radius, segments) {
    ...
    var texture = new THREE.TextureLoader().load('../webgl/saturn_rings.png');
    var material = new THREE.MeshBasicMaterial({
        color: saturn.color,
